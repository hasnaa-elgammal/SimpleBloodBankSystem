        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (gridsender.Columns[e.ColumnIndex] is DataGridViewButtonColumn && e.RowIndex>=0)
            {
                try
                {
                    ...
                    d_class.BloodGroup = bloodgroupid(gridsender.Rows[e.RowIndex].Cells[3].Value.ToString());
                    d_class.Units = int.Parse(gridsender.Rows[e.RowIndex].Cells[4].Value.ToString());
